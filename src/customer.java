...
public class customer extends JFrame {
	...
	public customer() {
		...
		JLabel lblSection = new JLabel("customers Information");
		lblSection.setFont(new Font("Tahoma", Font.PLAIN, 22));
		
		JButton btnSAdd = new JButton("Add customer");
		...
		JButton btnSUpdate = new JButton("Modify customer Details");
		...
		JButton btnSDelete = new JButton("Delete customer");
		...
		JButton btnView = new JButton("View All customers");
