			...
			EventQueue.invokeLater(new Runnable() {
				public void run() {
					try {
						...
						frame.setTitle("Delete booking Info.");
			...
			btnDelete.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					if(sid==null||sid.trim().equals("")){
						JOptionPane.showMessageDialog(deletebooking.this,"id. can't be blank");
					}else{
						
						int i=bookingdetails.deletebooking(sid);
						if(i>0){
							JOptionPane.showMessageDialog(deletebooking.this,"booking Record deleted successfully!");
						}else{
							JOptionPane.showMessageDialog(deletebooking.this,"Unable to delete given booking details.!");
						}
					}
				}
			});
